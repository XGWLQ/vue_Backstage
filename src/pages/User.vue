...
export default {
  ...
  data () {
    ...
    return {
      ...
      total: 0, // 总用户列表页
      addDialogVisible: false, // 用来控制添加用户对话框的显示隐藏
      UpdataDialogVisible: false, // 用来控制添加用户对话框的显示隐藏
  ...
  methods: {
    ...
    async UpdataUser (id) {
      ...
      this.UpdataDialogVisible = !this.UpdataDialogVisible
    },
    // 修改用户
    updataUserSure () {
